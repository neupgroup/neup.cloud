...
export default function StatusPage() {
    ...
    // For RAM percentage we'd need total, but average used MB is fine or we can calculate % if total is constant. 
    // Let's stick to MB for Avg or calculate % if we can. 
    // statusData.ramHistory[0].total is available usually.
